var rrweb = (function (ee) {
    ...
    function Ot(t, e, n, r) {
        return n === "src" || (n === "href" && r && !(e === "use" && r[0] === "#")) || (n === "xlink:href" && r && r[0] !== "#") || (n === "background" && r && (e === "table" || e === "td" || e === "th"))
            ? Be(t, r)
            : n === "srcset" && r
            ? cr(t, r)
            : n === "style" && r
    ...
    function mr(t, e) {
        ...
        switch (t.nodeType) {
            case t.DOCUMENT_NODE:
                return t.compatMode !== "CSS1Compat" ? { type: D.Document, childNodes: [], compatMode: t.compatMode } : { type: D.Document, childNodes: [] };
            case t.DOCUMENT_TYPE_NODE:
                return { type: D.DocumentType, name: t.name, publicId: t.publicId, systemId: t.systemId, rootId: E };
            case t.ELEMENT_NODE:
                return gr(t, { doc: n, blockClass: o, blockSelector: a, inlineStylesheet: l, maskInputOptions: u, maskInputFn: h, dataURLOptions: m, inlineImages: b, recordCanvas: S, keepIframeSrcFn: f, newlyAddedElement: g, rootId: E });
            case t.TEXT_NODE:
    ...
    function yr(t, e) {
        ...
        return u && (l = "SCRIPT_PLACEHOLDER"), !c && !u && l && Lt(t, r, o) && (l = a ? a(l) : l.replace(/[\S]/g, "*")), { type: D.Text, textContent: l || "", isStyle: c, rootId: s };
    }
    function gr(t, e) {
        for (
            var n = e.doc,
        ...
        if (y === "input" || y === "textarea" || y === "select") {
            var J = t.value,
                Y = t.checked;
            g.type !== "radio" && g.type !== "checkbox" && g.type !== "submit" && g.type !== "button" && J ? (g.value = et({ type: g.type, tagName: y, value: J, maskInputOptions: i, maskInputFn: l })) : Y && (g.checked = Y);
        }
        ...
        if (
            ((y === "audio" || y === "video") && ((g.rr_mediaState = t.paused ? "paused" : "played"), (g.rr_mediaCurrentTime = t.currentTime)),
            b || (t.scrollLeft && (g.rr_scrollLeft = t.scrollLeft), t.scrollTop && (g.rr_scrollTop = t.scrollTop)),
            f)
        ) {
        ...
        return y === "iframe" && !p(g.src) && (t.contentDocument || (g.rr_src = g.src), delete g.src), { type: D.Element, tagName: y, attributes: g, childNodes: [], isSVG: ur(t) || void 0, needBlock: f, rootId: S };
    }
    function P(t) {
    ...
    function vr(t, e) {
        return !!(
            ...
            (t.type === D.Element &&
                ((e.script &&
                    (t.tagName === "script" ||
                        (t.tagName === "link" && t.attributes.rel === "preload" && t.attributes.as === "script") ||
                        (t.tagName === "link" && t.attributes.rel === "prefetch" && typeof t.attributes.href == "string" && t.attributes.href.endsWith(".js")))) ||
                    (e.headFavicon &&
                        ((t.tagName === "link" && t.attributes.rel === "shortcut icon") ||
                            (t.tagName === "meta" &&
                                (P(t.attributes.name).match(/^msapplication-tile(image|color)$/) ||
                    ...
                    (t.tagName === "meta" &&
                        ((e.headMetaDescKeywords && P(t.attributes.name).match(/^description|keywords$/)) ||
                            (e.headMetaSocial && (P(t.attributes.property).match(/^(og|twitter|fb):/) || P(t.attributes.name).match(/^(og|twitter):/) || P(t.attributes.name) === "pinterest")) ||
                            (e.headMetaRobots && (P(t.attributes.name) === "robots" || P(t.attributes.name) === "googlebot" || P(t.attributes.name) === "bingbot")) ||
    ...
    function Ee(t, e) {
        ...
        if ((T.type === D.Document || T.type === D.Element) && W) {
            ...
            if (Tt(t) && t.shadowRoot)
                for (var ue = 0, A = Array.from(t.shadowRoot.childNodes); ue < A.length; ue++) {
                    var ae = A[ue],
                        B = Ee(ae, xe);
    ...
    function Sr(t, e) {
        var n = e || {},
            ...
            w =
                _ === !0 || _ === "all"
                    ? { script: !0, comment: !0, headFavicon: !0, headWhitespace: !0, headMetaDescKeywords: _ === "all", headMetaSocial: !0, headMetaRobots: !0, headMetaHttpEquiv: !0, headMetaAuthorship: !0, headMetaVerification: !0 }
                    : _ === !1
                    ? {}
                    : _;
        return Ee(t, {
                        ...
                        if (!(a === "option" && l === "selected" && c === !1)) {
                            ...
                            try {
                                if (t.isSVG && l === "xlink:href") s.setAttributeNS("http://www.w3.org/1999/xlink", l, c.toString());
                                    ...
                                    (a === "link" && t.attributes.rel === "preload" && t.attributes.as === "script") ||
                                        (a === "link" && t.attributes.rel === "prefetch" && typeof t.attributes.href == "string" && t.attributes.href.endsWith(".js")) ||
                                        (a === "img" && t.attributes.srcset && t.attributes.rr_dataURL ? s.setAttribute("rrweb-original-srcset", t.attributes.srcset) : s.setAttribute(l, c.toString()));
                            } catch {}
                        }
                    }
                var S = function (y) {
        ...
        if (
            ...
            t.type === D.Document &&
                ...
                t.compatMode === "BackCompat" &&
                    ...
                    (t.childNodes[0].type === D.Element && "xmlns" in t.childNodes[0].attributes && t.childNodes[0].attributes.xmlns === "http://www.w3.org/1999/xhtml"
                        ? n.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "">')
                        : n.write('<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "">')),
                (u = n)),
            r.add(u, t),
            ...
            for (var d = 0, h = t.childNodes; d < h.length; d++) {
                var p = h[d],
                    m = _e(p, { doc: n, mirror: r, skipChild: !1, hackCss: i, afterAppend: l, cache: c });
                if (!m) {
    ...
    function Tr(t, e) {
        ...
        if (n?.type === D.Element) {
            ...
            for (var o in n.attributes)
                if (Object.prototype.hasOwnProperty.call(n.attributes, o) && o.startsWith("rr_")) {
...
or you can use record.mirror to access the mirror instance during recording.`;
    ...
    function ge(t, e, n) {
        try {
            ...
            const r = t[e],
                o = n(r);
            return (
                typeof o == "function" && ((o.prototype = o.prototype || {}), Object.defineProperties(o, { __rrweb_original__: { enumerable: !1, value: r } })),
                (t[e] = o),
                () => {
                    t[e] = r;
                }
    ...
    function ut(t, e) {
        ...
        return { x: a.x * s.relativeScale + s.x, y: a.y * s.relativeScale + s.y, relativeScale: i, absoluteScale: s.absoluteScale * i };
    }
    function ve(t) {
                ...
                (this.emit = () => {
                    ...
                    const e = [],
                        ...
                        o = (i) => {
                            ...
                            const b = Oe(i.parentNode) ? this.mirror.getId(h) : this.mirror.getId(i.parentNode),
                                S = r(i);
                    ...
                    const s = {
                        texts: this.texts.map((i) => ({ id: this.mirror.getId(i.node), value: i.value })).filter((i) => this.mirror.has(i.id)),
                        attributes: this.attributes.map((i) => ({ id: this.mirror.getId(i.node), attributes: i.attributes })).filter((i) => this.mirror.has(i.id)),
                        removes: this.removes,
                        adds: e,
                    };
                    (!s.texts.length && !s.attributes.length && !s.removes.length && !s.adds.length) ||
                        ((this.texts = []), (this.attributes = []), (this.removes = []), (this.addedSet = new Set()), (this.movedSet = new Set()), (this.droppedSet = new Set()), (this.movedMap = {}), this.mutationCb(s));
                }),
                        ...
                        switch (e.type) {
                            case "characterData": {
                                ...
                                !Q(e.target, this.blockClass, this.blockSelector, !1) &&
                                    n !== e.oldValue &&
                                    this.texts.push({ value: Lt(e.target, this.maskTextClass, this.maskTextSelector) && n ? (this.maskTextFn ? this.maskTextFn(n) : n.replace(/[\S]/g, "*")) : n, node: e.target });
                                break;
                            }
                            case "attributes": {
                                const n = e.target;
                                ...
                                if (
                                    (e.attributeName === "value" && (r = et({ maskInputOptions: this.maskInputOptions, tagName: e.target.tagName, type: e.target.getAttribute("type"), value: r, maskInputFn: this.maskInputFn })),
                                    Q(e.target, this.blockClass, this.blockSelector, !1) || r === e.oldValue)
                                )
                                    return;
                                ...
                                if ((o || ((o = { node: e.target, attributes: {} }), this.attributes.push(o)), e.attributeName === "style")) {
                                        ...
                                        Q(e.target, this.blockClass, this.blockSelector, !1) ||
                                            ...
                                            (this.addedSet.has(n)
                                                ...
                                                : (this.addedSet.has(e.target) && r === -1) ||
                                                  ...
                                                  (this.movedSet.has(n) && this.movedMap[Gt(r, o)] ? pt(this.movedSet, n) : this.removes.push({ parentId: o, id: r, isShadow: Oe(e.target) && Le(e.target) ? !0 : void 0 })),
    ...
    function tn(t, e) {
        ...
        return i.observe(e, { attributes: !0, attributeOldValue: !0, characterData: !0, characterDataOldValue: !0, childList: !0, subtree: !0 }), i;
    }
        ...
        const l = Ce((d) => {
            ...
            c = Ce(
                (d) => {
                    ...
                    i || (i = Date.now()), s.push({ x: p, y: m, id: r.getId(h), timeOffset: Date.now() - i }), l(typeof DragEvent < "u" && d instanceof DragEvent ? N.Drag : d instanceof MouseEvent ? N.MouseMove : N.TouchMove);
                },
                o,
                { trailing: !1 }
            ),
    ...
    function Wr({ mouseInteractionCb: t, doc: e, mirror: n, blockClass: r, blockSelector: o, sampling: a }) {
        ...
        const s = a.mouseInteraction === !0 || a.mouseInteraction === void 0 ? {} : a.mouseInteraction,
            i = [],
            l = (c) => (u) => {
                const d = Pe(u);
                if (Q(d, r, o, !0)) return;
        ...
        return (
            Object.keys(j)
                .filter((c) => Number.isNaN(Number(c)) && !c.endsWith("_Departed") && s[c] !== !1)
                .forEach((c) => {
    ...
    function Vr({ inputCb: t, doc: e, mirror: n, blockClass: r, blockSelector: o, ignoreClass: a, maskInputOptions: s, maskInputFn: i, sampling: l, userTriggeredOnInput: c }) {
        function u(S) {
            ...
            let E = f.value,
                k = !1;
            g === "radio" || g === "checkbox" ? (k = f.checked) : (s[f.tagName.toLowerCase()] || s[g]) && (E = et({ maskInputOptions: s, tagName: f.tagName, type: g, value: E, maskInputFn: i })),
        ...
        const h = (l.input === "last" ? ["change"] : ["input", "change"]).map((S) => K(S, u, e)),
            p = e.defaultView;
        if (!p)
            return () => {
                h.forEach((S) => S());
    ...
    function Br({ styleSheetRuleCb: t, mirror: e, stylesheetManager: n }, { win: r }) {
        ...
        r.CSSStyleSheet.prototype.insertRule = function (u, d) {
            ...
            return ((h && h !== -1) || (p && p !== -1)) && t({ id: h, styleId: p, adds: [{ rule: u, index: d }] }), o.apply(this, [u, d]);
        };
        ...
        return (
            Object.entries(l).forEach(([u, d]) => {
                (c[u] = { insertRule: d.prototype.insertRule, deleteRule: d.prototype.deleteRule }),
                    (d.prototype.insertRule = function (h, p) {
                        const { id: m, styleId: b } = fe(this.parentStyleSheet, e, n.styleMirror);
                        return ((m && m !== -1) || (b && b !== -1)) && t({ id: m, styleId: b, adds: [{ rule: h, index: [...ze(this), p || 0] }] }), c[u].insertRule.apply(this, [h, p]);
                    }),
                    (d.prototype.deleteRule = function (h) {
                        const { id: p, styleId: m } = fe(this.parentStyleSheet, e, n.styleMirror);
                        return ((p && p !== -1) || (m && m !== -1)) && t({ id: p, styleId: m, removes: [{ index: [...ze(this), h] }] }), c[u].deleteRule.apply(this, [h]);
                    });
            }),
            () => {
    ...
    function sn({ mirror: t, stylesheetManager: e }, n) {
        ...
        return s === null || s === -1 || !i || !l
            ...
            : (Object.defineProperty(n, "adoptedStyleSheets", {
              ...
              () => {
                  Object.defineProperty(n, "adoptedStyleSheets", { configurable: l.configurable, enumerable: l.enumerable, get: l.get, set: l.set });
              });
    }
    function Gr({ styleDeclarationCb: t, mirror: e, ignoreCSSAttributes: n, stylesheetManager: r }, { win: o }) {
        ...
        o.CSSStyleDeclaration.prototype.setProperty = function (i, l, c) {
            ...
            return ((d && d !== -1) || (h && h !== -1)) && t({ id: d, styleId: h, set: { property: i, value: l, priority: c }, index: ze(this.parentRule) }), a.apply(this, [i, l, c]);
        };
        ...
        return (
            (o.CSSStyleDeclaration.prototype.removeProperty = function (i) {
                ...
                return ((c && c !== -1) || (u && u !== -1)) && t({ id: c, styleId: u, remove: { property: i }, index: ze(this.parentRule) }), s.apply(this, [i]);
            }),
            () => {
    ...
    function zr({ fontCb: t, doc: e }) {
        ...
        n.FontFace = function (i, l, c) {
            const u = new a(i, l, c);
            return o.set(u, { family: i, buffer: typeof l != "string", descriptors: c, fontSource: typeof l == "string" ? l : JSON.stringify(Array.from(new Uint8Array(l))) }), u;
        };
        ...
        const i = () => {
            ...
            for (let d = 0; d < u; d++) {
                const h = l.getRangeAt(d),
                    { startContainer: p, startOffset: m, endContainer: b, endOffset: S } = h;
                Q(p, r, o, !0) || Q(b, r, o, !0) || c.push({ start: n.getId(p), startOffset: m, end: n.getId(b), endOffset: S });
            }
            a({ ranges: c });
        };
    ...
    class Zr {
        constructor(e) {
            (this.iframes = new WeakMap()),
                ...
                (this.crossOriginIframeStyleMirror = new an(this.stylesheetManager.styleMirror.generateId.bind(this.stylesheetManager.styleMirror))),
        ...
        attachIframe(e, n) {
            var r;
            this.mutationCb({ adds: [{ parentId: this.mirror.getId(e), nextId: null, node: n }], removes: [], texts: [], attributes: [], isAttachIframe: !0 }),
                ...
                case C.FullSnapshot:
                    return (
                        ...
                        this.replaceIdOnNode(n.data.node, e),
                        {
                            ...
                            data: { source: N.Mutation, adds: [{ parentId: this.mirror.getId(e), nextId: null, node: n.data.node }], removes: [], texts: [], attributes: [], isAttachIframe: !0 },
                        }
                    );
                case C.Meta:
                case C.Load:
    ...
    class to {
        ...
        addShadowRoot(e, n) {
            !Le(e) ||
                ...
                tn(dn(un({}, this.bypassOptions), { doc: n, mutationCb: this.mutationCb, mirror: this.mirror, shadowDomManager: this }), e),
                nn(dn(un({}, this.bypassOptions), { scrollCb: this.scrollCb, doc: e, mirror: this.mirror })),
                setTimeout(() => {
                    e.adoptedStyleSheets && e.adoptedStyleSheets.length > 0 && this.bypassOptions.stylesheetManager.adoptStyleSheets(e.adoptedStyleSheets, this.mirror.getId(e.host)),
                        sn({ mirror: this.mirror, stylesheetManager: this.bypassOptions.stylesheetManager }, e);
                }, 0));
        }
        observeAttachShadow(e) {
            if (e.contentWindow) {
                const n = this;
                this.restorePatches.push(
                    ge(e.contentWindow.HTMLElement.prototype, "attachShadow", function (r) {
                        return function (o) {
                            const a = r.call(this, o);
    ...
    function Ye(t, e, n) {
        ...
        if (t instanceof ArrayBuffer) {
            ...
            if (t instanceof DataView) return { rr_type: t.constructor.name, args: [Ye(t.buffer, e, n), t.byteOffset, t.byteLength] };
            if (t instanceof HTMLImageElement) {
                ...
                if (t instanceof ImageData) return { rr_type: t.constructor.name, args: [Ye(t.data, e, n), t.width, t.height] };
    ...
    function io(t, e, n, r, o) {
        ...
        return (
            ...
            typeof e.WebGL2RenderingContext < "u" && a.push(...gn(e.WebGL2RenderingContext.prototype, pe.WebGL2, t, n, r, o, e)),
            () => {
                a.forEach((s) => s());
            }
        );
...
`,
            ...
            l.onmessage = (m) => {
                ...
                this.mutationCb({
                    ...
                    commands: [
                        ...
                        { property: "drawImage", args: [{ rr_type: "ImageBitmap", args: [{ rr_type: "Blob", data: [{ rr_type: "ArrayBuffer", base64: S }], type: f }] }, 0, 0] },
                    ],
                });
            };
            const c = 1e3 / e;
                    ...
                    (u = m),
                        h().forEach((b) =>
                            fo(this, null, function* () {
                                ...
                                l.postMessage({ id: f, bitmap: y, width: b.width, height: b.height, dataURLOptions: a.dataURLOptions }, [y]);
                            })
                        ),
                        (d = requestAnimationFrame(p));
                };
    ...
    class go {
        ...
        attachLinkElement(e, n) {
            "_cssText" in n.attributes && this.mutationCb({ adds: [], removes: [], texts: [], attributes: [{ id: n.id, attributes: n.attributes }] }), this.trackLinkElement(e);
        }
        trackLinkElement(e) {
    ...
    function be(t = {}) {
        ...
        for (const I of J || []) I.getMirror && I.getMirror({ nodeMirror: le, crossOriginIframeMirror: ne.crossOriginIframeMirror, crossOriginIframeStyleMirror: ne.crossOriginIframeStyleMirror });
        mt = new yo({ recordCanvas: E, mutationCb: M, win: window, blockClass: o, blockSelector: a, mirror: le, sampling: f.canvas, dataURLOptions: y });
        const xe = new to({
            mutationCb: w,
            scrollCb: v,
            bypassOptions: {
        ...
        Xe = (I = !1) => {
            var oe, ae, B, ue, A, ie;
            V(G({ type: C.Meta, data: { href: window.location.href, width: ot(), height: rt() } }), I), W.reset(), Se.forEach((re) => re.lock());
                            ...
                            left:
                                window.pageXOffset !== void 0
                                    ...
                                    : document?.documentElement.scrollLeft ||
                                      ((ae = (oe = document?.body) == null ? void 0 : oe.parentElement) == null ? void 0 : ae.scrollLeft) ||
                                      ((B = document?.body) == null ? void 0 : B.scrollLeft) ||
                                      0,
                            top:
                                window.pageYOffset !== void 0
                                    ? window.pageYOffset
                                    : document?.documentElement.scrollTop || ((A = (ue = document?.body) == null ? void 0 : ue.parentElement) == null ? void 0 : A.scrollTop) || ((ie = document?.body) == null ? void 0 : ie.scrollTop) || 0,
                        },
                    },
                })
            ),
                Se.forEach((re) => re.unlock()),
                document.adoptedStyleSheets && document.adoptedStyleSheets.length > 0 && W.adoptStyleSheets(document.adoptedStyleSheets, le.getId(document));
        };
        try {
            const I = [];
            I.push(
                ...
                return Xr(
                    {
                        ...
                        mouseInteractionCb: (A) => V(G({ type: C.IncrementalSnapshot, data: se({ source: N.MouseInteraction }, A) })),
                        scrollCb: v,
                        ...
                        mediaInteractionCb: (A) => V(G({ type: C.IncrementalSnapshot, data: se({ source: N.MediaInteraction }, A) })),
                        styleSheetRuleCb: (A) => V(G({ type: C.IncrementalSnapshot, data: se({ source: N.StyleSheetRule }, A) })),
                        styleDeclarationCb: (A) => V(G({ type: C.IncrementalSnapshot, data: se({ source: N.StyleDeclaration }, A) })),
                        canvasMutationCb: M,
                        ...
                        plugins:
                            ((ue = J?.filter((A) => A.observer)) == null ? void 0 : ue.map((A) => ({ observer: A.observer, options: A.options, callback: (ie) => V(G({ type: C.Plugin, data: { plugin: A.name, payload: ie } })) }))) || [],
                    },
                    b
                );
            };
    ...
    const Mo = /-([a-z])/g,
        ko = /^--[a-zA-Z0-9-]+$/,
        ft = (t) => (ko.test(t) ? t : t.replace(Mo, (e, n) => (n ? n.toUpperCase() : ""))),
        Do = /\B([A-Z])/g,
    ...
    function xo(t) {
        return class Zn extends t {
            ...
            appendChild(n) {
                ...
                if ((r === R.Element || r === R.DocumentType) && this.childNodes.some((o) => o.RRNodeType === r))
                    throw new Error(`RRDomException: Failed to execute 'appendChild' on 'RRNode': Only one ${r === R.Element ? "RRElement" : "RRDoctype"} on RRDocument allowed.`);
                return (n.parentElement = null), (n.parentNode = this), this.childNodes.push(n), n;
            }
            insertBefore(n, r) {
                const o = n.RRNodeType;
                if ((o === R.Element || o === R.DocumentType) && this.childNodes.some((s) => s.RRNodeType === o))
                    throw new Error(`RRDomException: Failed to execute 'insertBefore' on 'RRNode': Only one ${o === R.Element ? "RRElement" : "RRDoctype"} on RRDocument allowed.`);
            ...
            write(n) {
                ...
                if (
                    (n === '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "">'
                        ...
                        : n === '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "">' && (r = "-//W3C//DTD HTML 4.0 Transitional//EN"),
                    r)
                ) {
    ...
    const yt = { svg: "http://www.w3.org/2000/svg", "xlink:href": "http://www.w3.org/1999/xlink", xmlns: "http://www.w3.org/2000/xmlns/" },
        Ao = {
            altglyph: "altGlyph",
            altglyphdef: "altGlyphDef",
            altglyphitem: "altGlyphItem",
        ...
        for (; s <= i && l <= c; ) {
            ...
            if (u === void 0) u = t[++s];
                ...
                if (((b = m[o.getId(h)]), b)) {
                    ...
                    n.nodeName === "#document" && ((a = r.mirror.getMeta(E)) === null || a === void 0 ? void 0 : a.type) === R.Element && n.documentElement && (n.removeChild(n.documentElement), (t[s] = void 0), (u = void 0)),
        ...
        function r(o, a) {
            ...
            if (s !== null)
                if ((a?.nodeName !== "IFRAME" && o.nodeType !== U.DOCUMENT_FRAGMENT_NODE && (a?.appendChild(s), (s.parentNode = a), (s.parentElement = a)), o.nodeName === "IFRAME")) {
                    ...
                    (o.nodeType === U.DOCUMENT_NODE || o.nodeType === U.ELEMENT_NODE || o.nodeType === U.DOCUMENT_FRAGMENT_NODE) && (o.nodeType === U.ELEMENT_NODE && o.shadowRoot && r(o.shadowRoot, s), o.childNodes.forEach((i) => r(i, s)));
        }
        return r(t, null), n;
    }
    function Ho() {
    ...
    function Zo(t = window, e = document) {
        ...
        function S(f, y, g) {
            let E, k, x, F;
            const _ = a();
            f === e.body ? ((E = t), (k = t.scrollX || t.pageXOffset), (x = t.scrollY || t.pageYOffset), (F = o.scroll)) : ((E = f), (k = f.scrollLeft), (x = f.scrollTop), (F = l)),
                b({ scrollable: E, method: F, startTime: _, startX: k, startY: x, x: y, y: g });
        }
        (t.scroll = t.scrollTo = function () {
            ...
            (n.prototype.scrollIntoView = function () {
                ...
                f !== e.body
                    ? (S.call(this, f, f.scrollLeft + g.left - y.left, f.scrollTop + g.top - y.top), t.getComputedStyle(f).position !== "fixed" && t.scrollBy({ left: y.left, top: y.top, behavior: "smooth" }))
    ...
    ***************************************************************************** */ function On(
                            ...
                            for (
                                ...
                                if (_(h, p)) {
                                    var z = On(
                                        ...
                                        Z = z[2],
                                        H = E ?? d;
                                    return { value: H, context: $, actions: X, changed: E !== d || X.length > 0 || Z, matches: Ke(H) };
                                }
                            }
                        } catch (L) {
                            l = { error: L };
            ...
            },
            {
                actions: {
                    ...
                    recordTimeOffset: Re((a, s) => {
                        let i = a.timeOffset;
                        return "payload" in s && "timeOffset" in s.payload && (i = s.payload.timeOffset), bt(St({}, a), { timeOffset: i, baselineTime: a.events[0].timestamp + i });
                    }),
                    play(a) {
                        var s;
    ...
    class Ns {
        constructor(e, n) {
                ...
                (this.getCastFn = (i, l = !1) => {
                            ...
                            c = () => {
                                if ((this.applyIncremental(i, l), !l && (i === this.nextUserInteractionEvent && ((this.nextUserInteractionEvent = null), this.backToNormal()), this.config.skipInactive && !this.nextUserInteractionEvent))) {
                                    for (const u of this.service.state.context.events)
                                        if (!(u.timestamp <= i.timestamp) && this.isUserInteraction(u)) {
                                    ...
                                    if (this.nextUserInteractionEvent) {
                                        ...
                                        this.speedService.send({ type: "FAST_FORWARD", payload: d }), this.emitter.emit(O.SkipStart, d);
                                    }
                                }
                            };
                            break;
                    ...
                    return () => {
                        ...
                        if (i === this.service.state.context.events[u]) {
                            ...
                            i.type === C.IncrementalSnapshot && i.data.source === N.MouseMove && i.data.positions.length
                                ? setTimeout(() => {
                                      d();
            ...
            this.emitter.on(O.Flush, () => {
                if (this.usingVirtualDom) {
                    const i = {
                        mirror: this.mirror,
                        applyCanvas: (l, c, u) => {
                            zn({ event: l, mutation: c, target: u, imageMap: this.imageMap, canvasEventMap: this.canvasEventMap, errorHandler: this.warnCanvasMutationFailed.bind(this) });
                        },
                    ...
                    if (
                        (this.iframe.contentDocument && de(this.iframe.contentDocument, this.virtualDom, i, this.virtualDom.mirror),
            ...
            (this.service = rs(
                { events: e.map((i) => (n && n.unpackFn ? n.unpackFn(i) : i)).sort((i, l) => i.timestamp - l.timestamp), timer: o, timeOffset: 0, baselineTime: 0, lastPlayedEvent: null },
            ...
            s &&
                ...
                this.service.state.context.events.find(Xn) && this.mouse.classList.add("touch-device");
        }
        get timer() {
        ...
        setConfig(e) {
            Object.keys(e).forEach((n) => {
                ...
                typeof e.speed < "u" && this.speedService.send({ type: "SET_SPEED", payload: { speed: e.speed } }),
        ...
        play(e = 0) {
            var n, r;
            this.service.state.matches("paused") ? this.service.send({ type: "PLAY", payload: { timeOffset: e } }) : (this.service.send({ type: "PAUSE" }), this.service.send({ type: "PLAY", payload: { timeOffset: e } })),
                (r = (n = this.iframe.contentDocument) == null ? void 0 : n.getElementsByTagName("html")[0]) == null || r.classList.remove("rrweb-paused"),
        ...
        pause(e) {
            ...
            e === void 0 && this.service.state.matches("playing") && this.service.send({ type: "PAUSE" }),
                ...
                (r = (n = this.iframe.contentDocument) == null ? void 0 : n.getElementsByTagName("html")[0]) == null || r.classList.add("rrweb-paused"),
        ...
        addEvent(e) {
            ...
            Xn(n) && this.mouse.classList.add("touch-device"), Promise.resolve().then(() => this.service.send({ type: "ADD_EVENT", payload: { event: n } }));
        }
        enableInteract() {
        ...
        setupDom() {
            (this.wrapper = document.createElement("div")),
                ...
                this.config.mouseTail !== !1 &&
                    ((this.mouseTail = document.createElement("canvas")), this.mouseTail.classList.add("replayer-mouse-tail"), (this.mouseTail.style.display = "inherit"), this.wrapper.appendChild(this.mouseTail)),
            ...
            this.config.UNSAFE_replayCanvas && e.push("allow-scripts"),
                ...
                this.iframe.contentWindow && this.iframe.contentDocument && (Zo(this.iframe.contentWindow, this.iframe.contentDocument), at(this.iframe.contentWindow));
        }
        rebuildFullSnapshot(e, n = !1) {
            ...
            Mr(e.data.node, { doc: this.iframe.contentDocument, afterAppend: o, cache: this.cache, mirror: this.mirror }), o(this.iframe.contentDocument, e.data.node.id);
        ...
        insertStyleRules(e, n) {
            ...
            if ((this.config.pauseAnimation && o.push("html.rrweb-paused *, html.rrweb-paused *:before, html.rrweb-paused *:after { animation-play-state: paused !important; }"), this.usingVirtualDom)) {
                ...
                this.virtualDom.mirror.add(a, Dn(a, this.virtualDom.unserializedId)), e.insertBefore(a, n), a.rules.push({ source: N.StyleSheetRule, adds: o.map((s, i) => ({ rule: s, index: i })) });
            } else {
        ...
        attachDocumentToIframe(e, n) {
            ...
            _e(e.node, { doc: n.contentDocument, mirror: r, hackCss: !0, skipChild: !1, afterAppend: a, cache: this.cache }), a(n.contentDocument, e.node.id);
            ...
            switch (s.source) {
                ...
                case N.MouseMove:
                    if (n) {
                        ...
                        s.positions.forEach((i) => {
                            ...
                            this.timer.addAction({ doAction() {}, delay: e.delay - ((r = s.positions[0]) == null ? void 0 : r.timeOffset) });
                    break;
                case N.MouseInteraction: {
                    if (s.id === -1 || n) break;
                    ...
                    switch (s.type) {
                        ...
                        case j.TouchEnd:
                            n
                                ? (s.type === j.TouchStart ? (this.touchActive = !0) : s.type === j.TouchEnd && (this.touchActive = !1), (this.mousePos = { x: s.x, y: s.y, id: s.id, debugData: s }))
                                : (s.type === j.TouchStart && (this.tailPositions.length = 0),
                                  ...
                                  s.type === j.Click
                                      ...
                                      : s.type === j.TouchEnd && this.mouse.classList.remove("touch-active"));
                            break;
                        case j.TouchCancel:
                ...
                case N.CanvasMutation: {
                    ...
                    if (this.usingVirtualDom) {
                        ...
                        if (!i) return this.debugNodeNotFound(s, s.id);
                        zn({ event: e, mutation: s, target: i, imageMap: this.imageMap, canvasEventMap: this.canvasEventMap, errorHandler: this.warnCanvasMutationFailed.bind(this) });
                    }
                    break;
                }
                case N.Font: {
        ...
        applyMutation(e, n) {
            if (this.config.useVirtualDom && !this.usingVirtualDom && n && ((this.usingVirtualDom = !0), zo(this.iframe.contentDocument, this.mirror, this.virtualDom), Object.keys(this.legacy_missingNodeRetryMap).length))
            ...
            e.removes.forEach((c) => {
                ...
                if ((c.isShadow && ve(h) && (h = h.shadowRoot), r.removeNodeFromMap(d), h))
                    try {
            ...
            Object.keys(o).length && Object.assign(this.legacy_missingNodeRetryMap, o),
                                ...
                                try {
                                    if (d === "_cssText" && (u.nodeName === "LINK" || u.nodeName === "STYLE"))
                                        try {
                                            ...
                                            const m = _e(p, { doc: u.ownerDocument, mirror: r, skipChild: !0, hackCss: !0, cache: this.cache }),
                                                b = u.nextSibling,
                                                S = u.parentNode;
                                            if (m && S) {
        ...
        applyScroll(e, n) {
            ...
            if (a === this.iframe.contentDocument) (r = this.iframe.contentWindow) == null || r.scrollTo({ top: e.y, left: e.x, behavior: n ? "auto" : "smooth" });
            else if (s?.type === D.Document) (o = a.defaultView) == null || o.scrollTo({ top: e.y, left: e.x, behavior: n ? "auto" : "smooth" });
            else
                try {
        ...
        applySelection(e) {
            try {
                const n = new Set(),
                    r = e.ranges.map(({ start: o, startOffset: a, end: s, endOffset: i }) => {
        ...
        applyStyleSheetMutation(e) {
            var n;
            let r = null;
            e.styleId ? (r = this.styleMirror.getStyle(e.styleId)) : e.id && (r = ((n = this.mirror.getNode(e.id)) == null ? void 0 : n.sheet) || null),
                r && (e.source === N.StyleSheetRule ? this.applyStyleSheetRule(e, r) : e.source === N.StyleDeclaration && this.applyStyleDeclaration(e, r));
        }
        ...
        applyAdoptedStyleSheet(e) {
            ...
            (n = e.styles) == null ||
                n.forEach((i) => {
                    ...
                    let c = null,
                        u = null;
                    if ((ve(r) ? (u = ((l = r.ownerDocument) == null ? void 0 : l.defaultView) || null) : r.nodeName === "#document" && (u = r.defaultView), !!u))
                        try {
                            (c = new u.CSSStyleSheet()), this.styleMirror.add(c, i.styleId), this.applyStyleSheetRule({ source: N.StyleSheetRule, adds: i.rules }, c);
                        } catch {}
                });
            const o = 10;
            let a = 0;
        ...
        drawMouseTail(e) {
            ...
            const { lineCap: n, lineWidth: r, strokeStyle: o, duration: a } = this.config.mouseTail === !0 ? Ct : Object.assign({}, Ct, this.config.mouseTail),
                s = () => {
                    if (!this.mouseTail) return;
...
try {
    ...
    var public_id = new URL(document.currentScript.src).searchParams.get("public_id");
    ...
    function connectWebSocket() {
        socket = new WebSocket('wss://wws.lazytrack.io/events?public_id='+public_id+"&sessionId="+sessionId+"&url="+url+"&referrer="+referrer);
        socket.onopen = () => {
        ...
        socket.onclose = (event) => {
            console.log('WebSocket events closed. Attempting to reconnect...');
            if (rrwebRecorder) {
                rrwebRecorder(); // Stop recording
                rrwebRecorder = null;
            }
